...
const Footer = () => (
  <footer className="w-full py-12 border-t border-gray-200 dark:border-[#262626] bg-white dark:bg-[#0A0A0B] transition-colors">
    <div className="flex flex-col md:flex-row justify-between items-center px-8 max-w-7xl mx-auto gap-4">
      <span className="text-sm font-black text-gray-900 dark:text-white">MERN.DEV</span>
      <span className="font-manrope text-xs text-gray-500 dark:text-zinc-500 uppercase tracking-widest">© 2024 Built with MERN Stack</span>
