...
const Navbar = () => (
  <nav className="fixed top-0 w-full z-50 bg-[#0A0A0B]/80 backdrop-blur-md border-b border-[#262626]">
      ...
      <div className="hidden md:flex gap-8 items-center">
        {['About', 'Skills', 'Education', 'Projects', 'Contact'].map((item, i) => (
          <motion.a 
            ...
            className="font-manrope text-sm font-medium tracking-wide text-zinc-400 hover:text-[#2D8CFF] transition-all duration-300" 
